import { BaseRecord, HttpError, useShow } from "@refinedev/core";
...
const DepartmentShow = () => {
  ...
  const CardTable = <TData extends BaseRecord> ({
    title,
    total,
    table,
  }: {
  ...
  return (
    <ShowView className="class-view space-y-6">
      <ShowViewHeader
        resource="departments"
        title={details.departmentDetails?.name}
      />
      ...
      <Card className="hover:shadow-md transition-shadow">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            {details.departmentDetails?.description ??
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <CardTotal
              ...
              value={details.totals.subjects}
              icon={<BookOpen className="h-4 w-4" />}
            />
            <CardTotal
              title="Total Classes"
              value={details.totals.classes}
              icon={<Layers className="h-4 w-4" />}
            />

            <CardTotal
              title="Enrolled Students"
              value={details.totals.enrolledStudents}
      ...
      <CardTable
        title="Subjects"
        total={details.totals.subjects}
        table={subjectsTable}
      />

      <CardTable
        title="Classes"
        total={details.totals.classes}
        table={classesTable}
      />
